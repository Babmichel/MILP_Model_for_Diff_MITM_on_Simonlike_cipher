...
def parameters_display(parameters, solution):
        ...
        if parameters["key_schedule_linearity"] == 1:
                print("key quantity :", solution['total_key_information'])
...
def pdf_display(parameters, solution):
        ...
        fig.savefig(f'figures_folder/{parameters["pdf_name"]}_up', format='pdf',  bbox_inches='tight', dpi=300)
        ...
        draw.set_xlim(x_min, x_max)
        draw.set_ylim(y_min, y_max)
        fig.savefig(f'figures_folder/{parameters["pdf_name"]}_down', format='pdf',  bbox_inches='tight', dpi=300)
